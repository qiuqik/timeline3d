...
// adapted for legaltimeline
    ...
    function handleMouseMovePan( event ) {
        ...
        // restict panning for user to not go too fat
        if(scope.object.position.z < -2730 && panDelta.y > 0 || scope.object.position.z > 1500 && panDelta.y < 0){}else{pan( panDelta.x, panDelta.y );}
